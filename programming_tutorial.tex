...
\author{miko-misa \and yoshihiro}
\date{June 2023}
...
% Start of Selection
\section{データ型とは}
プログラミング言語には「型」といった概念が存在します.前章でプログラミング言語は情報を情報たらしめるルールであることを確認しました.しかしどんな情報でも等しく扱えるわけではありません.たとえば,ここに「5」が存在するとします.「これに『3』を加えてください」と言われた場合,あなたは何と答えるでしょうか.多くの方はおそらく「8」と答えたことでしょう.しかし,「53」と答える方も少なからずいるのではないでしょうか.そう答えなかったとしても「53」という答えには納得できると思います.これは与えられたもの---ここではあえて「数値」という呼称は避けますが---が数字なのか文字なのかという認識の違いです.人間は柔軟に考えることができますが,すべてが数値化されたコンピュータではこの違いは大変な差異となります.前者の場合,「5」は$101_{(2)}$\footnote{2進法で5.}という数字であり,後者の場合は\terlogy{U+0035}\footnote{Unicode表記で"5".}という文字になるのです.もしあなたが数字としての「5」と文字としての「3」を足してくださいと言われたら困るでしょう.
\\
\\
